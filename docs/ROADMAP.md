...
**目标**：Windows 与 macOS 成为稳定主创作端，并支持受控范围内的 Office 二次编辑。

- Tauri 2 桌面壳，共享 Web 前端与 Python sidecar。
- 原生文件选择、拖入素材、最近项目、系统托盘和本地密钥安全存储。
- PPTX 可编辑模式：文字、图片、基础图形、表格和图表组件映射。
- Doc / Archdoc 的 DOCX 语义导出；复杂视觉元素明确扁平化。
