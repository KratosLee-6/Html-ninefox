...
> 制定日期：2026-08-31
> 当前开发基线：v0.5.0-rc1 Project Memory 本地复利闭环（稳定发布基线仍为 v0.4.2）
> 目标：先让真实用户稳定完成“提出需求 → 生成 HTML → 预览 → 反馈修改 → 导出/分享”，再扩展平台数量。

> 2026-09-18：RC2 本地增量已接入版本差异、命名、恢复为新版本、键盘与 100 节点验收；包版本仍为 RC1。详见 [迭代记录](ITERATION-RC2-20260918.md) 和 [测试报告](TEST-REPORT-RC2-20260918.md)。下方早期 Sprint 清单为历史规划，最新执行顺序以该记录为准。
