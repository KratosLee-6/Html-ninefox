...
> 制定日期：2026-08-31
> 当前开发基线：v0.5.0-beta2 Recipe Run 可观测与局部重跑（稳定发布基线仍为 v0.4.2）
...
**阶段计划**：alpha1 统一组件与状态（已完成）；beta1 完成自由拖动、磁吸滞回、精准端口、稳定连线和可见区域适配（已完成）；beta2 完成 Recipe Run MVP（已完成）；RC 完成 Project Memory MVP、性能与无障碍。
