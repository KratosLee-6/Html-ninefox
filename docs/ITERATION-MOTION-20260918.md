...
功能开发基线为 `0.5.0rc1`。本轮动效与版本历史闭环已经纳入应用预发布版 [`v0.5.0rc2`](https://github.com/KratosLee-6/Html-ninefox/releases/tag/v0.5.0rc2)；安装包和最终校验记录见 [发布测试报告](TEST-REPORT-v0.5.0rc2.md)。
