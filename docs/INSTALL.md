...
文件：`HtmlNineFox-Windows-x64-0.5.0rc3.zip`
...
文件：`HtmlNineFox-Linux-0.5.0rc3.run`

```bash
chmod +x HtmlNineFox-Linux-0.5.0rc3.run
./HtmlNineFox-Linux-0.5.0rc3.run
```
...
```bash
./HtmlNineFox-Linux-0.5.0rc3.run --no-launch
```

## Python wheel

```bash
python -m pip install ./htmlninefox-0.5.0rc3-py3-none-any.whl
htmlninefox app
```
